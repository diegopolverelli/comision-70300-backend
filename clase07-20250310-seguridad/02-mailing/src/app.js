...
await mongoose.connect('mongodb+srv://coderhouse:codercoder2023@cluster0.wpxpupc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&dbName=comis70300clase07')
console.log(`DB online`)
// await inicializaUsuarios()


// LAMP Linux Apache MySql PHP
// input: "ABC0001"   Front    llegaba al back como "codigo_empresa"
// input: "AAA' or 1=1"   Front    llegaba al back como "codigo_empresa"
// sQuery="SELECT * FROM CLIENTES WHERE CODIGO = '" + codigo_empresa + "'"
// lanzan la consulta a DB

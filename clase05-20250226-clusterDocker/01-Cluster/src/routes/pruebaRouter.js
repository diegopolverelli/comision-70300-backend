...
router.get('/op1',(req,res)=>{
    ...
    console.log(valor1, valor2, resultado, `pid: ${process.pid}`, `worker n° ${cluster.worker.id}`)
...
router.get('/op2',(req,res)=>{
    ...
    console.log(contador, resultado, `pid: ${process.pid}`, `worker n° ${cluster.worker.id}`)
    console.timeEnd("Demora operación:")
